...
- Reconsider bull (25) multiplier behavior — real darts only allows single/double bull (50 max), no triple. Currently allowed for simplicity in countdown modes.
